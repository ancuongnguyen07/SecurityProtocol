...
\begin{figure}
    ...
    \caption{The new NISEC protocol.}\label{fig:nisec_protocol}
...
\begin{figure}
    ...
    \caption{Countermeasure of type flaw attack.}\label{fig:countermeasure_tf_attack}
...
\begin{figure}
    ...
    \caption{Replay attack --- an old session key was leaked.}\label{fig:replay_attack}
\end{figure}
